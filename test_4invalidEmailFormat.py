...
def test_login_popup_appears(page: Page):
    ...
    page.get_by_role('textbox', name='input field for E.g. jane.doe').fill("test")
    page.get_by_role('button', name='Log In').click()

    checkEmail = has_login_field_error_message_appeared(page, "Please enter a valid e-mail")
