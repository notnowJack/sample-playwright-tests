...
def test_login_popup_appears(page: Page):
    ...
    error_element = page.get_by_text("You have made 2 of 5 incorrect login attempt(s).")
    ...
    checkEmail = has_login_field_error_message_appeared(page, "You have made 2 of 5 incorrect login attempt(s).", 0, not_bold)
